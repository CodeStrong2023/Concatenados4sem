...
@RestController /*Anotación para confirmar de que se trata un controlador el cual será revisado por swagger*/
@RequestMapping("api/v1/tasks")
@RequiredArgsConstructor
public class TaskController { //Ésta capa solo se comunica con la capa de servicio
